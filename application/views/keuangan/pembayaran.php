...
<<<<<<< HEAD <nav class="navbar navbar-expand-lg" style="background:darkgrey">
    ...
    <div class="collapse navbar-collapse">
      <ul class="navbar-nav">
        <li class="nav-item">
          ...
          <a class="nav-link active" aria-current="page" style="text-align:center;margin-left: 200px;">
            <h1>WELCOME TO THE WEB SIS RAHMA</h1>
            <hr>
          </a>
        </li>
      </ul>
  ...
  <div class="d-flex">
    ...
    <div class="row container py-3">
      <div class="container py-3 h-auto">
        <h1 style="background-color:blue; height: 60px; text-align:center;">
          <font color='white'>DATA PEMBAYARAN</font>
        </h1>
        <table class="table">
            ...
            foreach ($pembayaran as $row) : $no++ ?>
              <tr>
                ...
                <td>
                  ...
                  <button onclick="hapus(<?php echo $row->id ?>)" class="btn btn-outline-danger">
